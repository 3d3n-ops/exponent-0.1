...
def generate_code_improvement(original_prompt: str, improvement_request: str, dataset_info: dict, current_files: list) -> dict:
    """Generate improved code based on user request."""
    from exponent.core.code_gen import make_ai_request
...
"""
    ...
    content = make_ai_request(improvement_prompt)
...
"""
    ...
    generated_script = make_ai_request(training_prompt)
...
"""
        ...
        recovery_analysis = make_ai_request(recovery_prompt)
